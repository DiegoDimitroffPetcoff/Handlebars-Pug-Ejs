...
app.get("/", function (req, res) {
  ...
  res.render("main", { Mascotas: contenedor.read(), tagline: tagline });
});
...
app.get("/about", function (req, res) {
  res.render("about", { Mascotas: contenedor.read() });
});
...
//   // let objetoCompletoSegunID = { title: "no", price: "no", id: "no" };
//   // if (req == true) {
//   //   let objetoCompletoSegunID = "buscar";
//   // } else {
//   let objetoCompletoSegunID = contenedor.getById(req.body.ID);
//   // }
//   // const objetoSegunID = req.body.id;

//   res.render("pages/objectSearched", {
//     // objetoSegunID: objetoSegunID,
//     objetoCompletoSegunID: objetoCompletoSegunID,
//   });
// });
